...
export const chainLogos = Object.entries({
  ...
  'Automata FiniteState': nodeAutomataContextFree,
  'Automata Mainnet': nodeAutomataContextFree,
...
export const nodeLogos = Object.entries({
  ...
  'Automata FiniteState Node': nodeAutomataContextFree,
  'Automata Mainnet Node': nodeAutomataContextFree,
